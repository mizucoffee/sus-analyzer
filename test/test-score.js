...
ava('Short Tick', t => t.is(score.shortNotes[8].tick, 0))
ava('Short Width', t => t.is(score.shortNotes[8].width, 4))

ava('Default BPM1', t =>
  t.is(SusAnalyzer.getScore('#BPM01: 100\n#00308: 01\n#00510:00').BPMs[0], 120)
)
ava('Default BPM2', t =>
  t.is(SusAnalyzer.getScore('#00308: 01\n#00510:00').BPMs[0], 120)
)
ava('Default BEATs', t => t.is(SusAnalyzer.getScore('').BEATs[0], 4))
