...
ava('VALIDATE BAD SUS - MISSING META',t => t.true(SusAnalyzer.validate("#TITLE test").MISSING_META.toString() === [ 'SONGID', 'ARTIST', 'DESIGNER', 'DIFFICULTY', 'PLAYLEVEL', 'WAVE', 'WAVEOFFSET', 'BASEBPM' ].toString()))
